...
return {
  ...
  config = function()
    vim.g.mellow_highlight_overrides = {
      ...
      ['LspReferenceText'] = { underline = false, bg = '#27272a' }, -- Adjust color to match your theme
      ['LspReferenceRead'] = { underline = false, bg = '#27272a' },
      ['LspReferenceWrite'] = { underline = false, bg = '#27272a' },
    }
